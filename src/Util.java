...
public class Util {
    ...
    public static BufferedImage applyBranding(BufferedImage liveImg) {
        ...
        } catch (Exception e) { System.err.println("Logo-Fehler: " + e.getMessage()); }

        GeneralFont font = new GeneralFont("Arial Narrow", 50);
        Float[] HFU_GREEN = RGBColour.RGB(0.0F, 0.5176F, 0.3020F);
        
        mbfImage.drawText(PepperSelfie.config.imageText(), PepperSelfie.config.positionX(), 70, font, 40, HFU_GREEN);
        mbfImage.drawText(PepperSelfie.config.imageDate(), 450, 110, font, 30, HFU_GREEN);
